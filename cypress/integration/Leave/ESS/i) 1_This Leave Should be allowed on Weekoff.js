...
describe('i) 1_This Leave Should be allowed on Weekoff', function () {
	...
	it('Setting for Set Weekoff', function () {
        cy.visit(Cypress.env('url')+ '/Settings/Employee/Index?module=leave&submodule=leaveweeklyoff');
        ...
        cy.get('#Leave_WeeklyOff').click();
		cy.wait(2000)
        cy.get('#listWeekDays_0__DayChecked').check();
        cy.get('#btnSave').click();
		cy.wait(2000)
        cy.get('#btnProcess').click();
		cy.wait(2000)
        cy.get('#chkAllDates').check();
        cy.get('#btnSave').click();
		cy.wait(2000)
        
    })
	
    it('Setting for This Leave Should allowed on Weekoff', function () {
