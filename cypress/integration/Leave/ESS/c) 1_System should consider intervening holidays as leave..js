...
describe('c) System should consider intervening holidays as leave.', function () {
   ...
   it('Login to Cloud', function () {
    ...
    it('Setting for System should consider intervening holidays as leave.', function () {
